...
-- Create feedback_corrections table for RAG system
...
-- Create vector similarity search index (IVFFlat for efficiency)
CREATE INDEX IF NOT EXISTS idx_feedback_embedding ON feedback_corrections 
